				...
				<div class="instalacion row">
					...
					<div class="descripcion col-md-7">
						...
						<p class="opciones">
							...
							<br>
							<br>
						   	<b class="Q">2.</b>	Rellenar campo con documentos de identidad
							<br>
						   	<br>
						   	<b class="Q">3.</b>	Rellenar campo con correo electronico
							<br>
						   	<br>
						   	<b class="Q">4.</b>	Seleccionar Coordinador 
							<br>
							<br>
						   	<b class="Q">5.</b>	Rellenar campo no es obligatorio  
							 <br>
							 <br>
						   	<b class="Q">6.</b>	Seleccionar el boton enviar
						</p>
					</div>
				</div>
